...
void shares::seqdisp()
{
	...
	fstream file("shares.txt",ios::in);
	file.seekg(0,ios::beg);
	cout<<setiosflags(ios::left)<<setw(15)<<"Music ID"<<setw(15)<<"Category"<<setw(15)<<"type";
	cout<<setw(20)<<"Artist name"<<setw(15)<<"Album name";
	cout<<"---------------------------------------------------------------------------"<<endl;
	while(!file.eof())
	{
		std.Unpack(file);
...
int main ()
{
	...
	do
	{
		...
		cout<<"******************************************";
		gotoxy(18,8);
		cout<<"* 1: Display all Musics using B-Tree";
		gotoxy(59,8);
		cout<<"*";
		gotoxy(18,10);
		cout<<"* 2: Add music record into the file";
		gotoxy(59,10);
		cout<<"*";
		gotoxy(18,12);
		cout<<"* 3: Search for music record using B-Tree";
		gotoxy(59,12);
		cout<<"*";gotoxy(18,14);
		cout<<"* 4: Delete music record";
		gotoxy(59,14);
		cout<<"*";
		gotoxy(18,16);
		cout<<"* 5: Update music record";
		gotoxy(59,16);
		cout<<"*";
		gotoxy(18,18);
		...
		switch(ch)
		{
			case '1': clrscr();
				  ...
				  cout<<"******************************************";
				  gotoxy(20,4);
				  cout<<"*  DISPLAY ALL MUSICS USING B-TREE  *";
				  gotoxy(20,6);
				  cout<<"******************************************\n\n";
				  display(bt.root);
				  break;
			case '2': clrscr();
				  ...
				  cout<<"******************************";
				  gotoxy(22,4);
				  cout<<"*  ADD MUSICS RECORD INTO THE FILE  *";
				  gotoxy(22,6);
				  cout<<"******************************\n\n";
				  append();
				  in.write();
			...
			case '3': clrscr();
				  ...
				  cout<<"************************************";
				  gotoxy(22,4);
				  cout<<"*  SEARCH FOR MUSICS RECORD USING B-TREE  *";
				  gotoxy(22,6);
				  cout<<"************************************\n\n";
			...
			case '4': clrscr();
				  ...
				  cout<<"*******************";
				  gotoxy(28,4);
				  cout<<"*  DELETE MUSIC RECORD  *";
				  gotoxy(28,6);
				  cout<<"*******************\n\n";
				  cout<<"\n\t Enter the Music ID to delete : ";
				  cin>>key;
				  delrec(key);
				  s.del(key);
				  delete head;
